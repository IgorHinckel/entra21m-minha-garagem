...
public class CategoriaJUnitTest {
    ...
    public void alterar() {
        ...
        Categoria categoriaBuscada = new CategoriaDAO().buscCategoriaPorId(categoria.getId());
    ...
    public void buscarPorId() {
        ...
        Categoria categoriaBuscada = new CategoriaDAO().buscCategoriaPorId(codigoInserido);
